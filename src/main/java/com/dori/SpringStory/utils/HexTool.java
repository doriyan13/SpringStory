...
import com.dori.SpringStory.constants.CharsetConstants;
...
public interface HexTool {
     ...
     */
    static String toCompactHexString(byte[] bytes) {
    ...
    static String toStringFromAscii(final byte[] bytes) {
