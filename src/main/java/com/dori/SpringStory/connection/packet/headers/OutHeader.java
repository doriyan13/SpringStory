...
public enum OutHeader {
    ...
    WorldInformation(10),
    SelectWorldResult(11), // CHAR_LIST
    ...
    SetAvatarMegaphone(115),
    ClearAvatarMegaphone(116),
    ...
    CUserLocalSitResult(231),
    CUserEmotion(232),
    CUserEffect(233),
    CUserLocalTeleport(234),
    CUserLocalMesoGiveSucceeded(236),
    CUserLocalMesoGiveFailed(237),
    CUserLocalRandomMesobagSucceeded(238),
    CUserLocalRandomMesobagFailed(239),
    CUserLocalFieldFadeInOut(240),
    CUserLocalFieldFadeOutForce(241),
    CUserLocalQuestResult(242),
    CUserLocalNotifyHPDecByField(243),
    CUserLocalBalloonMsg(245),
    CUserLocalPlayEventSound(246),
    CUserLocalPlayMinigameSound(247),
    CUserLocalMakerResult(248),
    CUserLocalOpenClassCompetitionPage(250),
    CUserLocalOpenUI(251),
    CUserLocalOpenUIWithOption(252),
    CUserLocalSetDirectionMode(253),
    CUserLocalSetStandAloneMode(254),
    CUserLocalHireTutor(255),
    CUserLocalTutorMsg(256),
    CUserLocalIncComboResponse(257),
    CUserRandomEmotion(258),
    CUserLocalResignQuestReturn(259),
    CUserLocalPassMateName(260),
    CUserLocalRadioSchedule(261),
    CUserLocalOpenSkillGuide(262),
    CUserLocalNoticeMsg(263),
    CUserLocalChatMsg(264),
    CUserLocalBuffzoneEffect(265),
    CUserLocalGoToCommoditySN(266),
    CUserLocalDamageMeter(267),
    CUserLocalTimeBombAttack(268),
    CUserPassiveMove(269),
    CUserLocalFollowCharacterFailed(270),
    CUserLocalVengeanceSkillApply(271),
    CUserLocalExJablinApply(272),
    CUserLocalAskAPSPEvent(273),
    CUserLocalQuestGuideResult(274),
    CUserLocalDeliveryQuest(275),
    CUserLocalSkillCooltimeSet(276),
    ...
    CUserRemoteHit(218),
    CUserRemoteEmotion(219),
    CUserRemoteSetActiveEffectItem(220),
    CUserRemoteShowUpgradeTombEffect(221),
    CUserRemoteSetActivePortableChair(222),
    CUserRemoteAvatarModified(223), //TODO::Need to handle after invOperation!!!!
    CUserRemoteEffect(224),
    CUserRemoteSetTemporaryStat(225),
    CUserRemoteResetTemporaryStat(226),
    CUserRemoteReceiveHP(227),
